...
function nlt_customer_list() {
    ?>
    <link type="text/css" href="<?php echo WP_PLUGIN_URL; ?>/customer/style-admin.css" rel="stylesheet" />
    <div class="wrap">
        <h2>Customer</h2>
        <div class="tablenav top">
            <div class="alignleft actions">
                <a href="<?php echo admin_url('admin.php?page=nlt_customer_create'); ?>">Add New Customer</a>
            </div>
            <br class="clear">
        </div>
        <?php
        ...
        <table class='wp-list-table widefat fixed striped posts'>
            ...
            <?php foreach ($rows as $row) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo admin_url('admin.php?page=nlt_customer_update&id=' . $row->id); ?>">Update</a></td>
                </tr>
            <?php } ?>
        </table>
    </div>
