<?php
function sync_corporate_update() {
	global $wpdb;
...
//update
    if (isset($_POST['update'])) {
		...
		else
		{
			...
			$message1="Corporate updated successfully.";
		}
    }
//delete
    ...
    <div class="wrap">
        <h2>Corporate Edit</h2>
        <?php if ($_POST['delete']) { ?>
            <div class="updated"><p>Corporate deleted</p></div>
            <a href="<?php echo admin_url('admin.php?page=sync_corporate_list') ?>">&laquo; Back to Corporate list</a>
        <?php }else{ ?>
